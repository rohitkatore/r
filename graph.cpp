...
7.Exit
Enter your choice=4
Enter roll no to search=40

Roll no.= 40 is not present in the record
        ***MENU***
1.Accept
2.Display
3.Insert
...
7.Exit
Enter your choice=6
Enter roll no to modify=20
Enter roll no=30
Enter name=Amar
Enter division=A
Enter address=Mumabi
